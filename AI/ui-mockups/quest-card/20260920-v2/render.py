...
def main():
    ...
    manifest = {
        'version': '20260920-v2', 'purpose': 'Quest UI visual concept only',
        'revision': {'previous': '../20260920-v1/quest-card-preview.png',
                     'changes': ['Centered the title separator vertically.',
                                 'Progress fill #3CB450 -> #2C7338; removed the harsh 1px full text outline.'],
                     'reason': 'Keep progress digits clean and readable at the original display size.'},
