...
- 일반 라이트닝은 최초 청록색 낙뢰 시트와 빠른 3연속 낙하 패턴을 사용하며 각성의 추가 낙뢰도 같은 연출로 이어진다. 천벌 개화는 별도로 유지한다. 운석은 1.5초 동안 가속 낙하하며 본체 회전·화염 흐름·파편을 함께 표현하고, 화염 회오리의 상단 실루엣은 잘린 평면처럼 보이지 않도록 검수한다.
